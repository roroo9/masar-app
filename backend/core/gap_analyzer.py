...
_tfidf_cache: dict = {}
_tfidf_cache_time: float = 0.0
_TFIDF_TTL = 600  # 10 minutes
...
def get_tfidf_weights() -> Dict[int, float]:
    ...
    if _tfidf_cache and (time.monotonic() - _tfidf_cache_time) < _TFIDF_TTL:
        return _tfidf_cache
    ...
    _tfidf_cache = weights
    _tfidf_cache_time = time.monotonic()
    return weights
